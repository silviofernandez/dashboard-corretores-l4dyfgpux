  ...
  return (
    <header className="flex items-center justify-between px-6 md:px-8 py-4 md:py-6 bg-slate-900/50 backdrop-blur-md border-b border-white/5 z-10 shrink-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          href="/admin"
          className="hidden sm:flex items-center justify-center p-2 rounded-full hover:bg-white/10 text-white/70 hover:text-white transition-colors border border-transparent hover:border-white/10"
          title="Painel Admin"
        >
          <svg
